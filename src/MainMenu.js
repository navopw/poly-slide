PolySlide.States.MainMenu = ds.class({
	...
	create: function() {
		...
		this.header.scale.set(PolySlide.assetScale(4.0), PolySlide.assetScale(4.0));
		this.header.alpha = 0;
		...
		this.play_button.scale.set(PolySlide.assetScale(3), PolySlide.assetScale(3));
		...
		this.mute_button.scale.set(PolySlide.assetScale(3), PolySlide.assetScale(3));
		...
		this.twitter_button.scale.set(PolySlide.assetScale(6), PolySlide.assetScale(6));
