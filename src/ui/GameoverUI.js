PolySlide.GameoverUI = ds.class({
	...
	show: function(instance) {
        ...
        this.gameover_text.scale.set(PolySlide.assetScale(3), PolySlide.assetScale(3));
        ...
        this.restart_button.scale.set(PolySlide.assetScale(6), PolySlide.assetScale(6));
        ...
        this.menu_button.scale.set(PolySlide.assetScale(6), PolySlide.assetScale(6));
