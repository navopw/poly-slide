PolySlide.PauseUI = ds.class({
	...
	show: function(instance) {
        ...
        this.pause_text.scale.setTo(PolySlide.assetScale(3), PolySlide.assetScale(3));
        ...
        this.resume_button.scale.setTo(PolySlide.assetScale(6), PolySlide.assetScale(6));
        ...
        this.restart_button.scale.setTo(PolySlide.assetScale(6), PolySlide.assetScale(6));
        ...
        this.menu_button.scale.setTo(PolySlide.assetScale(6), PolySlide.assetScale(6));
